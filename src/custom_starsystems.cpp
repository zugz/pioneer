...
#define FIXED_DEG2RAD(n,d) (sfloat(n,d) * sfloat(31416, 1800000))

const CustomSBody sol_system[] = {
	{ "Sol", SBody::TYPE_STAR_G,
	  -1, sfloat(1,1), sfloat(1,1), 5700 },
	{ "Mercury", SBody::TYPE_PLANET_SMALL,
	  0, sfloat(38,100), sfloat(55,1000), 340,
	  sfloat(387,1000), sfloat(205,1000), { (float)DEG2RAD(7.0) }, sfloat(59,1),
       	  FIXED_DEG2RAD(1,100)	},
	{ "Venus", SBody::TYPE_PLANET_CO2_THICK_ATMOS,
	  0, sfloat(95,100), sfloat(815,1000), 735,
	  sfloat(723,1000), sfloat(7,1000), { (float)DEG2RAD(3.39) }, sfloat(243,1),
          FIXED_DEG2RAD(26,10)	},
	{ "Earth", SBody::TYPE_PLANET_INDIGENOUS_LIFE,
	  0, sfloat(1,1), sfloat(1,1), 288,
	  sfloat(1,1), sfloat(167,10000), {}, sfloat(1,1), FIXED_DEG2RAD(2344,100), ECON_INDUSTRY,
	  "data/earth.hmap"
	},
	{ "Shanghai", SBody::TYPE_STARPORT_SURFACE,
	  3, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(31), (float)DEG2RAD(-121) } },
	{ "Mexico City", SBody::TYPE_STARPORT_SURFACE,
	  3, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(19), (float)DEG2RAD(99) } },
	{ "London", SBody::TYPE_STARPORT_SURFACE,
	  3, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(51), 0 } },
	{ "Moscow", SBody::TYPE_STARPORT_SURFACE,
	  3, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(55), (float)DEG2RAD(-37.5) } },
	{ "Brasilia", SBody::TYPE_STARPORT_SURFACE,
	  3, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(-15.5), (float)DEG2RAD(48.0) } },
	{ "Los Angeles", SBody::TYPE_STARPORT_SURFACE,
	  3, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(34), (float)DEG2RAD(118) } },
	{ "Gates Spaceport", SBody::TYPE_STARPORT_ORBITAL,
	  3, sfloat(), sfloat(), 0, sfloat(100,100000), sfloat(), { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(1,24*60*3) },
	{ "Moon", SBody::TYPE_PLANET_DWARF,
	  3, sfloat(273,1000), sfloat(12,1000), 220,
	  sfloat(257,100000), sfloat(549,10000), { (float)DEG2RAD(5.145) }, sfloat(273,10),
          FIXED_DEG2RAD(668,100) },
	{ "Lunar City", SBody::TYPE_STARPORT_SURFACE,
	  11, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(19), (float)DEG2RAD(99) } },
	{ "Mars", SBody::TYPE_PLANET_TERRAFORMED_GOOD,
	  0, sfloat(533,1000), sfloat(107,1000), 274,
	  sfloat(152,100), sfloat(933,10000), { (float)DEG2RAD(1.85) }, sfloat(1027,1000), 
	  FIXED_DEG2RAD(2519,100), ECON_INDUSTRY, },
	{ "Cydonia", SBody::TYPE_STARPORT_SURFACE,
	  13, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(-29), (float)DEG2RAD(124) } },
	{ "Olympus Mons", SBody::TYPE_STARPORT_SURFACE,
	  13, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(30), (float)DEG2RAD(-37) } },
	{ "Mars High", SBody::TYPE_STARPORT_ORBITAL,
	  13, sfloat(), sfloat(), 0, sfloat(5068,100000000), sfloat(), { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(11,24) },
	{ "Phobos", SBody::TYPE_PLANET_LARGE_ASTEROID,
	  13, sfloat(21,10000), sfloat(18,10000000000LL), 233,
	  sfloat(6268,100000000), sfloat(151,10000), { (float)DEG2RAD(1.093) }, sfloat(11,24) },
	{ "Deimos", SBody::TYPE_PLANET_ASTEROID,
	  13, sfloat(12,10000), sfloat(25,100000000000LL), 233,
	  sfloat(1568,10000000), sfloat(2,10000), { (float)DEG2RAD(0.93) }, sfloat(30,24) },
	{ "Phobos Base", SBody::TYPE_STARPORT_SURFACE,
	  17, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(5), (float)DEG2RAD(-5) } },
	{ "Tomm's Sanctuary", SBody::TYPE_STARPORT_SURFACE,
	  18, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(0), (float)DEG2RAD(0) } },
	{ "Jupiter", SBody::TYPE_PLANET_LARGE_GAS_GIANT,
	  0, sfloat(11,1), sfloat(3178,10), 165,
	  sfloat(5204,1000), sfloat(488,10000), { (float)DEG2RAD(1.305) }, sfloat(4,10),
          FIXED_DEG2RAD(313,100) },
	{ "Saturn", SBody::TYPE_PLANET_MEDIUM_GAS_GIANT,
	  0, sfloat(9,1), sfloat(95152,1000), 134,
	  sfloat(9582,1000), sfloat(557,10000), { (float)DEG2RAD(2.485) }, sfloat(4,10),
          FIXED_DEG2RAD(2673,100) },
	{ "Uranus", SBody::TYPE_PLANET_SMALL_GAS_GIANT,
	  0, sfloat(4,1), sfloat(145,10), 76,
	  sfloat(19229,1000), sfloat(444,10000), { (float)DEG2RAD(0.772) }, sfloat(7,10),
          FIXED_DEG2RAD(9777,100) },
	{ "Neptune", SBody::TYPE_PLANET_SMALL_GAS_GIANT,
	  0, sfloat(38,10), sfloat(17147,100), 72,
	  sfloat(30104,1000), sfloat(112,10000), { (float)DEG2RAD(1.768) }, sfloat(75,100),
          FIXED_DEG2RAD(2832,100) },
	// moons of jupiter
	{ "Io", SBody::TYPE_PLANET_HIGHLY_VOLCANIC,
	  21, sfloat(286,1000), sfloat(15,1000), 130,
	  sfloat(282,100000), sfloat(41,10000), { (float)DEG2RAD(2.21) }, sfloat(177,100) },
	{ "Europa", SBody::TYPE_PLANET_WATER,
	  21, sfloat(245,1000), sfloat(8,1000), 102,
	  sfloat(441,100000), sfloat(9,1000), {}, sfloat(355,100) },
	{ "Clarke's Station", SBody::TYPE_STARPORT_ORBITAL,
	  26, sfloat(), sfloat(), 0, sfloat(12,500000), sfloat(), { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(1,24*60*3) },
	{ "Ganymede", SBody::TYPE_PLANET_SMALL,
	  21, sfloat(413,1000), sfloat(25,1000), 110,
	  sfloat(72,10000), sfloat(13,10000), { (float)DEG2RAD(0.2) }, sfloat(72,10) },
	{ "Callisto", SBody::TYPE_PLANET_DWARF,
	  21, sfloat(378,1000), sfloat(18,1000), 134,
	  sfloat(126,10000), sfloat(74,10000), { (float)DEG2RAD(0.192) }, sfloat(167,10) },
	// moons of saturn
	{ "Titan", SBody::TYPE_PLANET_METHANE_THICK_ATMOS,
	  //22, sfloat(400,1000), sfloat(225,10000), 94, 
	  //sfloat(82,10000), sfloat(288,10000), { (float)DEG2RAD(0.34854) }, sfloat(15945,1000) },
	  22, sfloat(400,1000), sfloat(225,10000), 94,  //Oddness/ When correct Radius setting is used (0.4ER), planet has no atmosphere or gravity !?!?!
	  sfloat(82,10000), sfloat(288,10000), { (float)DEG2RAD(0.34854) }, sfloat(15945,1000) },
	{ "Oasis City", SBody::TYPE_STARPORT_SURFACE,
	  30, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(18.4), (float)DEG2RAD(196) } },
	{ "Port Makenzie", SBody::TYPE_STARPORT_SURFACE,
	  30, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(1), (float)DEG2RAD(14) } },
	{ "Rhea", SBody::TYPE_PLANET_DWARF,
	  22, sfloat(12,100), sfloat(39,100000), 81,
	  sfloat(441,100000), sfloat(126,100000), { (float)DEG2RAD(0.345) }, sfloat(452,100) },
	{ "Iapetus", SBody::TYPE_PLANET_DWARF,
	  22, sfloat(1155,10000), sfloat(3,10000), 115,
	  sfloat(238,10000), sfloat(29,1000), { (float)DEG2RAD(15.47) }, sfloat(7932,100) },
	{ "Dione", SBody::TYPE_PLANET_DWARF,
	  22, sfloat(881,10000), sfloat(328,1000000), 87,
	  sfloat(252,100000), sfloat(22,10000), { (float)DEG2RAD(0.019) }, sfloat(2737,1000) },
	// moons up uranus
	{ "Titania", SBody::TYPE_PLANET_DWARF,
	  23, sfloat(1235,10000), sfloat(5908,10000000), 70,
	  sfloat(2913,1000000), sfloat(11,10000), { (float)DEG2RAD(0.34) }, sfloat(87,10) },
	{ "Oberon", SBody::TYPE_PLANET_DWARF,
	  23, sfloat(1194,10000), sfloat(5046,10000000), 75,
	  sfloat(39,10000), sfloat(14,10000), { (float)DEG2RAD(0.058) }, sfloat(135,10) },
	{ "Umbriel", SBody::TYPE_PLANET_DWARF,
	  23, sfloat(92,1000), sfloat(2,10000), 75,
	  sfloat(178,100000), sfloat(39,10000), { (float)DEG2RAD(0.128) }, sfloat(4144,1000) },
	{ "Ariel", SBody::TYPE_PLANET_DWARF,
	  23, sfloat(908,10000), sfloat(226,1000000), 60,
	  sfloat(1277,1000000), sfloat(12,10000), { (float)DEG2RAD(0.26) }, sfloat(252,100) },
	// moons of neptune
	{ "Triton", SBody::TYPE_PLANET_WATER,
	  24, sfloat(2122,10000), sfloat(359,100000), 38,
	  sfloat(2371,100000), sfloat(16,1000000), { (float)DEG2RAD(156.885) }, sfloat(141,24) },
	{ "Nereid", SBody::TYPE_PLANET_ASTEROID,
	  24, sfloat(267,10000), sfloat(519,100000000), 50,
	  sfloat(3685,100000), sfloat(75,100), { (float)DEG2RAD(32.55) }, sfloat(115,240) },
	{ "Proteus", SBody::TYPE_PLANET_LARGE_ASTEROID,
	  24, sfloat(310,10000), sfloat(710,100000000), 51,
	  sfloat(786,1000000), sfloat(53,100000), { (float)DEG2RAD(0.524) }, sfloat(1122,1000) },
	// you know you want to call pluto a planet, you really do
	{ "Pluto", SBody::TYPE_PLANET_WATER,
	  0, sfloat(18,100), sfloat(21,10000), 44,
	  sfloat(394,10), sfloat(249,1000), { (float)DEG2RAD(11.88) }, sfloat(153,24),
          FIXED_DEG2RAD(296,10)	},
	// Extra bases down here, save re-ordering the primary.
	{ "Enki Catena", SBody::TYPE_STARPORT_SURFACE,
	  28, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(84), (float)DEG2RAD(96) } },
	{ "Pluto Research Base", SBody::TYPE_STARPORT_SURFACE,
	  43, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(84), (float)DEG2RAD(96) } },
	{ "Poseidon Station", SBody::TYPE_STARPORT_ORBITAL,
	  40, sfloat(), sfloat(), 0, sfloat(12,500000), sfloat(), { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(11,7) },
	//{ "Hotel Sol", SBody::TYPE_STARPORT_ORBITAL,
	 // 0, 0, 0, 0, sfloat(10,0), sfloat(500,1000), { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	 // sfloat(11,24) },
	{ "Daniel's Haven", SBody::TYPE_STARPORT_ORBITAL,
	  30, sfloat(), sfloat(), 0, sfloat(12,500000), sfloat(50,1000), { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(11,9) },
	{ "Discovery Base", SBody::TYPE_STARPORT_ORBITAL,
	  21, sfloat(), sfloat(), 0, sfloat(7,1000), sfloat(), { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(11,1) },
	{ "Dante's Base", SBody::TYPE_STARPORT_SURFACE,
	  25, sfloat(), sfloat(), 0, sfloat(), sfloat(), { (float)DEG2RAD(-0.5), (float)DEG2RAD(26.2) } },  //49
	{ 0 }
};
