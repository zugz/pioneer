...
const CustomSBody sol_system[] = {
	...
	{ "Gates Spaceport", SBody::TYPE_STARPORT_ORBITAL,
	  3, 0, 0, 0, sfloat(100,100000), 0, { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(1,24*60*3) },
	...
	{ "Mars High", SBody::TYPE_STARPORT_ORBITAL,
	  13, 0, 0, 0, sfloat(5068,100000000), 0, { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(11,24) },
	...
	{ "Clarke's Station", SBody::TYPE_STARPORT_ORBITAL,
	  26, 0, 0, 0, sfloat(12,500000), 0, { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(1,24*60*3) },
	...
	{ "Poseidon Station", SBody::TYPE_STARPORT_ORBITAL,
	  40, 0, 0, 0, sfloat(12,500000), 0, { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(11,7) },
	...
	{ "Daniel's Haven", SBody::TYPE_STARPORT_ORBITAL,
	  30, 0, 0, 0, sfloat(12,500000), sfloat(50,1000), { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(11,9) },
	{ "Discovery Base", SBody::TYPE_STARPORT_ORBITAL,
	  21, 0, 0, 0, sfloat(7,1000), 0, { (float)DEG2RAD(0), (float)DEG2RAD(0) },
	  sfloat(11,1) },
